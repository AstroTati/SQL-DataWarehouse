...
Each of the following views performs transformations and combines data from the 
Silver layer to produce a clean, enriched, and business-ready dataset.

Note that a Star Schema is utilized. Two dimensions (customers and products) 
and a fact table (sales) are created.
_______________________________________________________________________________
*/
